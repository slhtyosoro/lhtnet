// Type definitions for lhtnet.js
// Project: https://timetocode.com/lhtnet
...
interface EDictionary {
    ...
    /**
     * Adds an object to the EDictionary. The object *MUST* have a nid/id property as defined in the lhtnetConfig
     * @param obj 
     */
    add(obj: any): void
...
declare namespace lhtnet {
    export class Instance {
        ...
        // Warning: this function is only present if a lhtnet hooks mixin has been used.
        emitCommands(): void
        ...
        /**
         * Sleeps an entity, aka stops lhtnet from scanning the entity for changes each fick
         * @param entity 
         */
        ...
        /**
         * Wakes an entity, aka enables lhtnet scanning the entity for changes each tick
         * @param entity 
         */
    ...
    export class Client {
        ...
        /**
         * Reads any queued data from the server and emits it in the lhtnet hooks api format. Warning: this function is only present if a lhtnet hooks mixin has been used.
         */
